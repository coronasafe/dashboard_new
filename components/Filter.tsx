...
interface FilterProps {
  ...
  floating: boolean;
  content: number;
  filterFacilityTypes: string[];
  setFilterFacilityTypes: any;
  dateOnChange: OnChangeDateCallback;
  datesOnChange: OnChangeDateRangeCallback;
}
